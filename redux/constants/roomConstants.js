...
export const REVIEW_AVAILABILTY_REQUEST = 'REVIEW_AVAILABILTY_REQUEST';
export const REVIEW_AVAILABILTY_SUCCESS = 'REVIEW_AVAILABILTY_SUCCESS';
export const REVIEW_AVAILABILTY_FAIL = 'REVIEW_AVAILABILTY_FAIL';
